...
Pukbot is a small Rust CLI that dispatches a trusted GitHub Actions workflow to post disclosed comments through the Pukbot GitHub App.

## Rules

- Keep the GitHub App private key and installation tokens out of the CLI, local files, logs, and command output.
